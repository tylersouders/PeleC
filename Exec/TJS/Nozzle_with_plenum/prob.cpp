...
CDNozzle::build(
  ...
  // Handle upper/lower boxes
  amrex::Vector<amrex::Real> topboxlo, topboxhi, botboxlo, botboxhi;
  ...
  // Get triangles for the CD nozzle
  ...
  // Get number of triangles and coordinates from case file
