...
extern "C" {
  ...
  // Currently computing as 1/3th of the domain size, can change if necessary
    PeleC::h_prob_parm_device->turb_length_scale = 0.33 * (probhi[1]-problo[1]);
